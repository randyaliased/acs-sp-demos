...
18/10/2022 - Modifications and Acknowledgements:

This is a function that was taken from the python-acoustics library - https://github.com/python-acoustics
We modified this file to include the normalize functions from the signal module.
